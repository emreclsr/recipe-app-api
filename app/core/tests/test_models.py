...
from decimal import Decimal  # recipe object'te kullanılacak

from django.test import TestCase
from django.contrib.auth import get_user_model  # Helper function

from core import models  # başka modelleri çağırabilmek için ihtiyacımız var
...
class ModelTests(TestCase):
    ...
    def test_recipe_file_name_uuid(self, mock_uuid):
        ...
        uuid = "test-uuid"  # uuid'yi burada mock'luyoruz
