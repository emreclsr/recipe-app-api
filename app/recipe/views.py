...
@extend_schema_view(  # drf_spectacular'ın oluşturduğu OpenApi şemasına filtre için özellik ekliyor.
    list=extend_schema(
        parameters=[
            OpenApiParameter(
                "tags",
...
@extend_schema_view(
    list=extend_schema(
        parameters = [
            OpenApiParameter(
                "assigned_only",
                OpenApiTypes.INT, enum=[0, 1],  # sadece 0 ve 1 girilebilir. (False - True)
